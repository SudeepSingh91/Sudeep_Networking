		...
		const std::vector<sMaterialInfo>& i_materialInfo )
	{
		...
		if ( fout.is_open() )
		{
				...
				"{\n";
			{
				...
				{
					fout << "    {" + std::to_string(it->vertex.x) + ", " + std::to_string(it->vertex.y) + ", " + std::to_string(it->vertex.z) + ", " + std::to_string(it->vertex.r) + ", " + std::to_string(it->vertex.g) + ", " + std::to_string(it->vertex.b) + "},\n";
				}
				fout << "},\n";
			}
			{
				...
				{
					fout << "    " + std::to_string(static_cast<size_t>(i_indexBuffer.at(i))) + ",\n";
				}
				fout << "},\n";
			}
			{
